import { TOP_MODEL_ORDER, IMAGE_MODEL_ORDER, VIDEO_MODEL_ORDER } from '../../routing/modelRouter';
...
export const AVAILABLE_GEMINI_MODELS_CATALOG: CatalogModelItem[] = [
  // Flagship (Tier 1)
  { id: 'gemini-3.7-flash', name: 'Gemini 3.7 Flash', category: 'Text-out models', tier: 'tier1', description: 'Flagship hybrid reasoning, ultra cerdas untuk analisis naskah & video.' },
  ...
  { id: 'gemini-3.8-flash', name: 'Gemini 3.8 Flash', category: 'Text-out models', tier: 'tier1', description: 'Flagship performa mutakhir generasi terbaru.' },
  ...
  // Tier 2 (Multimodal & Text workhorses)
  { id: 'gemini-3.5-flash-lite', name: 'Gemini 3.5 Flash Lite', category: 'Text-out models', tier: 'tier2', description: 'Lightweight workhorse efisien tahan beban tinggi.' },
  { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', category: 'Text-out models', tier: 'tier2', description: 'Workhorse multimodal utama dengan limit tinggi & efisiensi stabil.' },
  { id: 'gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash Lite', category: 'Text-out models', tier: 'tier2', description: 'Resilient high-throughput lite model.' },
  { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite', category: 'Text-out models', tier: 'tier2', description: 'Penyelamat limit hemat biaya throughput tinggi.' },

  // Tier 3 (Fallback Ringan & Hemat)
  { id: 'gemini-2.0-flash-lite', name: 'Gemini 2.0 Flash Lite', category: 'Text-out models', tier: 'tier3', description: 'Ultra-lightweight fallback cadence.' },
  { id: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash', category: 'Text-out models', tier: 'tier3', description: 'Kecepatan kilat fallback generasi instan.' },

  // Legacy Models
  { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', category: 'Text-out models', tier: 'tier1', description: 'Deep reasoning untuk bedah video & angle konten rumit.' },
  { id: 'gemini-3.1-pro-preview', name: 'Gemini 3.1 Pro Preview', category: 'Text-out models', tier: 'tier1', description: 'Eksplorasi ide kreatif mendalam.' },
  { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', category: 'Text-out models', tier: 'tier1', description: 'Kapasitas konteks besar dan stabil.' },
  { id: 'gemini-1.5-flash', name: 'Gemini 1.5 Flash', category: 'Text-out models', tier: 'tier3', description: 'Fallback workhorse klasik.' },
  { id: 'gemini-1.5-pro', name: 'Gemini 1.5 Pro', category: 'Text-out models', tier: 'tier3', description: 'Konteks token panjang klasik.' },

  // Multi-modal & Images
  { id: 'gemini-3-pro-image', name: 'Nano Banana Pro (Gemini 3 Pro Image)', category: 'Multi-modal generative models', tier: 'specialized', description: 'Generasi gambar presisi tinggi fotorealistik.' },
  { id: 'gemini-3.1-flash-image', name: 'Nano Banana 2 (Gemini 3.1 Flash Image)', category: 'Multi-modal generative models', tier: 'specialized', description: 'Generasi visual cepat multi-gaya.' },
  { id: 'gemini-3.1-flash-lite-image', name: 'Nano Banana 2 Lite (Gemini 3.1 Flash Lite Image)', category: 'Multi-modal generative models', tier: 'specialized', description: 'Generasi gambar kilat ringan.' },
  { id: 'gemini-2.5-flash-preview-image', name: 'Nano Banana (Gemini 2.5 Flash Preview Image)', category: 'Multi-modal generative models', tier: 'specialized', description: 'Visual preview generator.' },
  ...
  // Audio / TTS
  { id: 'gemini-3.1-flash-tts', name: 'Gemini 3.1 Flash TTS', category: 'Voice / TTS', tier: 'specialized', description: 'Text-to-Speech natural intonasi tinggi.' },
  { id: 'gemini-2.5-flash-tts', name: 'Gemini 2.5 Flash TTS', category: 'Voice / TTS', tier: 'specialized', description: 'Voice generation stabil.' },
  { id: 'gemini-2.5-pro-tts', name: 'Gemini 2.5 Pro TTS', category: 'Voice / TTS', tier: 'specialized', description: 'High-fidelity audio synth.' },
  { id: 'lyria-3-clip', name: 'Lyria 3 Clip', category: 'Voice / TTS', tier: 'specialized', description: 'Audio & music segment generator.' },
  ...
  { id: 'gemini-embedding-2', name: 'Gemini Embedding 2', category: 'Other models', tier: 'specialized', description: 'High-dimensional embeddings v2.' }
];
