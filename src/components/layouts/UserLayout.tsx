...
export default function UserLayout({ session, onLogout, onGoToAdmin }: UserLayoutProps) {
  ...
  const navItemsTools = [
    ...
    { id: 'shop_ideas', label: 'Produk to Video', icon: ShoppingBag },
    { id: 'ideas', label: 'Replika Video Viral', icon: Lightbulb },
    { id: 'prompt', label: 'Ekstrak Prompt dari Video', icon: Clapperboard },
    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans flex flex-col md:flex-row antialiased">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-slate-900 tracking-tight leading-tight">Satset AI</h2>
                      <p className="text-xs text-slate-400">Creator Pro</p>
                    </div>
                  </div>
                ...
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <span>Riwayat</span>
                    {historyBadge > 0 && (
                      <span className="ml-auto bg-purple-100 text-[#7c3aed] font-bold text-xs px-2 py-0.5 rounded-full">
                        {historyBadge}
                      </span>
                    )}
                  </button>
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200/80 min-h-screen shrink-0 p-5 select-none justify-between">
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3 px-2 pb-2">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900 tracking-tight leading-none">Satset AI</h2>
              <p className="text-xs text-slate-400 mt-1">Creator Pro</p>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-200/80 px-4 sm:px-6 py-3 flex items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-3">
            <div 
              className="px-3 py-1 rounded-full bg-[#7c3aed] text-white font-bold text-xs flex items-center gap-1.5 select-none shadow-2xs"
                      ...
                      <div className="p-8 sm:p-12 rounded-2xl border border-slate-200/80 bg-white shadow-sm flex flex-col items-center justify-center text-center space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-slate-500 text-xs max-w-sm">
                            AI Vision Engine sedang menganalisis sinematografi adegan & memecah per <strong className="text-slate-800">{segmentDuration !== 'auto' ? segmentDuration + 's' : 'Penuh'}</strong>
                          </p>
                        </div>
